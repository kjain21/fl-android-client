...
class MNISTDataModule(pl.LightningDataModule):
  ...
  def setup(self, stage):
    ...
    # train_files_dir = files_dir + "MNIST/processed/train.pt"
    # test_files_dir = files_dir + "MNIST/processed/test.pt"
    # print(train_files_dir)
    # print(test_files_dir)
    # print(exists(files_dir+"MNIST/processed"), "MNISTp exists")
    # print(exists(files_dir+"MNIST/processed/"), "test exists")

    print(files_dir, "LOOOK HERE FOR FILES")

    mnist_train = MNIST(files_dir, train=True, download=True, transform=transform)
    mnist_test = MNIST(files_dir, train=False, download=True, transform=transform)
